...
const Map<BodyShapeId, FaceAnchor> kAnchors = {
  ...
  BodyShapeId.pebble: FaceAnchor(
      ...
      cheekY: 59,
      cheekOffset: 19),
  BodyShapeId.dumpling: FaceAnchor(
      cx: 50,
      eyeY: 58,
      eyeOffset: 11,
      eyeScale: 0.98,
